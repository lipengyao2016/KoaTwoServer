...
describe('user Test Case:', () => {
    ...
    describe('create test case:', function () {
        it('success create an user', function () {
            this.timeout(0);
            return request.postRequest(`${directUrl}/users`, userTestCase).then((_ref) => {
                let res = _ref.res,
                    body = _ref.body;
    ...
    describe('retrieve test case:', function () {
        it('success retrieve an user  ', function () {
            this.timeout(0);
            return request.getRequest(`${directUrl}/users/${userUUID}`).then((_ref2) => {
                let res = _ref2.res,
                    body = _ref2.body;
    ...
    describe('update test case:', function () {
        it('success update an user', function () {
            ...
            return request.postRequest(`${directUrl}/users/${userUUID}`, updateInfo).then((_ref3) => {
                let res = _ref3.res,
                    body = _ref3.body;
    ...
    describe('list test case:', function () {
        it('list users by directory:', function () {
            ...
            return request.getRequest(`${directUrl}/users`, qs).then((_ref4) => {
                let res = _ref4.res,
                    body = _ref4.body;
