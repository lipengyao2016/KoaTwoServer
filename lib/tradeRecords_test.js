...
describe('tradeRecord Test Case:', () => {
    ...
    describe('create test case:', function () {
        it('success create an tradeRecord', function () {
            this.timeout(0);
            return request.postRequest(`${directUrl}/tradeRecords`, tradeRecordTestCase).then((_ref) => {
                let res = _ref.res,
                    body = _ref.body;
    ...
    describe('retrieve test case:', function () {
        it('success retrieve an tradeRecord  ', function () {
            this.timeout(0);
            return request.getRequest(`${directUrl}/tradeRecords/${tradeRecordUUID}`).then((_ref2) => {
                let res = _ref2.res,
                    body = _ref2.body;
    ...
    describe('update test case:', function () {
        it('success update an tradeRecord', function () {
            ...
            return request.postRequest(`${directUrl}/tradeRecords/${tradeRecordUUID}`, updateInfo).then((_ref3) => {
                let res = _ref3.res,
                    body = _ref3.body;
    ...
    describe('list test case:', function () {
        it('list tradeRecords by directory:', function () {
            ...
            return request.getRequest(`${directUrl}/tradeRecords`, qs).then((_ref4) => {
                let res = _ref4.res,
                    body = _ref4.body;
