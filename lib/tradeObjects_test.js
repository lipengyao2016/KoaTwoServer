...
describe('tradeObject Test Case:', () => {
    ...
    describe('create test case:', function () {
        it('success create an tradeObject', function () {
            this.timeout(0);
            return request.postRequest(`${directUrl}/tradeObjects`, tradeObjectTestCase).then((_ref) => {
                let res = _ref.res,
                    body = _ref.body;
    ...
    describe('retrieve test case:', function () {
        it('success retrieve an tradeObject  ', function () {
            this.timeout(0);
            return request.getRequest(`${directUrl}/tradeObjects/${tradeObjectUUID}`).then((_ref2) => {
                let res = _ref2.res,
                    body = _ref2.body;
    ...
    describe('update test case:', function () {
        it('success update an tradeObject', function () {
            ...
            return request.postRequest(`${directUrl}/tradeObjects/${tradeObjectUUID}`, updateInfo).then((_ref3) => {
                let res = _ref3.res,
                    body = _ref3.body;
    ...
    describe('list test case:', function () {
        it('list tradeObjects by directory:', function () {
            ...
            return request.getRequest(`${directUrl}/tradeObjects`, qs).then((_ref4) => {
                let res = _ref4.res,
                    body = _ref4.body;
