...
var initialMysqlTestData = () => {
    ...
    let terminalPathUrl = 'http://' + config.externalServer_domain + ':5024/api/v1.0.0/tenants/0VnRpHOEcPpN1CICQ5yTOw' + '/deviceDirectorys/JfnBhZS9oLKoDFKHTxEmlw/terminals/';
    ...
    return knex.transaction(trx => {
        return knex('package').delete().transacting(trx).then(() => {
