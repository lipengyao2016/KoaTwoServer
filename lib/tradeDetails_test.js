...
describe('tradeDetail Test Case:', () => {
    ...
    describe('create test case:', function () {
        it('success create an tradeDetail', function () {
            this.timeout(0);
            return request.postRequest(`${directUrl}/tradeDetails`, tradeDetailTestCase).then((_ref) => {
                let res = _ref.res,
                    body = _ref.body;
    ...
    describe('retrieve test case:', function () {
        it('success retrieve an tradeDetail  ', function () {
            this.timeout(0);
            return request.getRequest(`${directUrl}/tradeDetails/${tradeDetailUUID}`).then((_ref2) => {
                let res = _ref2.res,
                    body = _ref2.body;
    ...
    describe('update test case:', function () {
        it('success update an tradeDetail', function () {
            ...
            return request.postRequest(`${directUrl}/tradeDetails/${tradeDetailUUID}`, updateInfo).then((_ref3) => {
                let res = _ref3.res,
                    body = _ref3.body;
    ...
    describe('list test case:', function () {
        it('list tradeDetails by directory:', function () {
            ...
            return request.getRequest(`${directUrl}/tradeDetails`, qs).then((_ref4) => {
                let res = _ref4.res,
                    body = _ref4.body;
