...
describe('serviceRecord Test Case:', () => {
    ...
    describe('create test case:', function () {
        it('success create an serviceRecord', function () {
            this.timeout(0);
            return request.postRequest(`${memberURL}/serviceRecords`, serviceRecordTestCase).then((_ref) => {
                let res = _ref.res,
                    body = _ref.body;
    ...
    describe('retrieve test case:', function () {
        it('success retrieve an serviceRecord  ', function () {
            this.timeout(0);
            return request.getRequest(`${memberURL}/serviceRecords/${serviceRecordUUID}`).then((_ref2) => {
                let res = _ref2.res,
                    body = _ref2.body;
    ...
    describe('update test case:', function () {
        it('success update an serviceRecord', function () {
            ...
            return request.postRequest(`${memberURL}/serviceRecords/${serviceRecordUUID}`, updateInfo).then((_ref3) => {
                let res = _ref3.res,
                    body = _ref3.body;
    ...
    describe('list test case:', function () {
        it('list serviceRecords by memberCard:', function () {
            ...
            return request.getRequest(`${memberURL}/serviceRecords`, qs).then((_ref4) => {
                let res = _ref4.res,
                    body = _ref4.body;
