...
describe('Member Test Case:', () => {
    ...
    describe('create test case:', function () {
        it('success create an Member', function () {
            this.timeout(0);
            return request.postRequest(`${directUrl}/members`, MemberTestCase).then((_ref) => {
                let res = _ref.res,
                    body = _ref.body;
    ...
    describe('retrieve test case:', function () {
        it('success retrieve an Member  ', function () {
            this.timeout(0);
            return request.getRequest(`${directUrl}/members/${MemberUUID}`).then((_ref2) => {
                let res = _ref2.res,
                    body = _ref2.body;
    ...
    describe('update test case:', function () {
        it('success update an Member', function () {
            ...
            return request.postRequest(`${directUrl}/members/${MemberUUID}`, updateInfo).then((_ref3) => {
                let res = _ref3.res,
                    body = _ref3.body;
    ...
    describe('list test case:', function () {
        it('list members by member:', function () {
            ...
            return request.getRequest(`${directUrl}/members`, qs).then((_ref4) => {
                let res = _ref4.res,
                    body = _ref4.body;
        ...
        it('list members by api:', function () {
            ...
            return request.getRequest(`${url}/members`, qs).then((_ref5) => {
                let res = _ref5.res,
                    body = _ref5.body;
