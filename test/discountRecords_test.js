...
describe('discountRecord Test Case:',()=>{
    ...
    describe('create test case:',  function(){
        it('success create an discountRecord',  function() {
            this.timeout(0);
            return request.postRequest(`${directUrl}/discountRecords`,discountRecordTestCase).then( ( { res, body} )=>{
    ...
    describe('retrieve test case:', function () {
        it('success retrieve an discountRecord  ', function () {
            this.timeout(0);
            return request.getRequest(`${directUrl}/discountRecords/${discountRecordUUID}`).then( ( { res, body} )=>{
    ...
    describe('update test case:', function () {
        it('success update an discountRecord', function () {
            ...
            return request.postRequest(`${directUrl}/discountRecords/${discountRecordUUID}`,updateInfo).then( ( { res, body} )=>{
    ...
    describe('list test case:', function () {
        it('list discountRecords by directory:', function () {
            ...
            return request.getRequest(`${directUrl}/discountRecords`,qs).then( ( { res, body} )=>{
