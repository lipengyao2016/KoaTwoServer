...
describe('payRecord Test Case:',()=>{
    ...
    describe('create test case:',  function(){
        it('success create an payRecord',  function() {
            this.timeout(0);
            return request.postRequest(`${directUrl}/payRecords`,payRecordTestCase).then( ( { res, body} )=>{
    ...
    describe('retrieve test case:', function () {
        it('success retrieve an payRecord  ', function () {
            this.timeout(0);
            return request.getRequest(`${directUrl}/payRecords/${payRecordUUID}`).then( ( { res, body} )=>{
    ...
    describe('update test case:', function () {
        it('success update an payRecord', function () {
            ...
            return request.postRequest(`${directUrl}/payRecords/${payRecordUUID}`,updateInfo).then( ( { res, body} )=>{
    ...
    describe('list test case:', function () {
        it('list payRecords by directory:', function () {
            ...
            return request.getRequest(`${directUrl}/payRecords`,qs).then( ( { res, body} )=>{
