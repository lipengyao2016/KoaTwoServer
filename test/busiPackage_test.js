    ...
    let bindPackageTestCase =
    {
       ...
       // packageProductHref:'http://192.168.7.210:5021/api/v1.0.0/tenants/nDy8dOynNil4KAdXrhJBog/productDirectorys/WhHLMwHCPz0XWdmCoPolSA/compositeProducts/64jyN9XmKHUpjBIivWwHSw',
        ...
        devices: [
            ...
            /*{
                sn: "19860042191696005621",
            },*/
             /* {
                sn: "99860042191696005642",
            },
           {
                sn: "99860042191696005643",
            },*/
            /*  {
                sn: "1311725000332154",
            },*/
   ...
   // PackageUUID = 'fCJev9bUYyH6CRXjUFd6Gg';
    ...
    describe('create test case:',  function(){
        it('success create an Package',  function() {
            this.timeout(0);
            return request.postRequest(`${url}/packages`,PackageTestCase,header).then( ( { res, body} )=>{
        ...
        it('success bindPackage an Package',  function() {
            this.timeout(0);
            return request.postRequest(`${url}/bindPackage`,bindPackageTestCase,header).then( ( { res, body} )=>{
        ...
        it('success createBindImport  Package',  function() {
            ...
            return request.postRequest(`${url}/importPackage`,bindPackageTestCase,header).then( ( { res, body} )=>{
        ...
        it('success active an Package',  function() {
            this.timeout(0);
            return request.postRequest(`${url}/openPackageService`,openPackageTestCase,header).then( ( { res, body} )=>{
    ...
    describe('list test case:', function () {
        it('list packages by all:', function () {
            ...
            return request.getRequest(`${url}/packages`,qs,header).then( ( { res, body} )=>{
        ...
        it('success get package import  excel template',  function() {
            ...
            return request.getRequest(`${url}/ImportExcelTemplate`,qs,header).then( ( { res, body} )=>{
