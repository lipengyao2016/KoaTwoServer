...
describe('tradeOrder Test Case:',()=>{
    ...
    describe('create test case:',  function(){
        it('success create an tradeOrder',  function() {
            this.timeout(0);
            return request.postRequest(`${directUrl}/tradeOrders`,tradeOrderTestCase).then( ( { res, body} )=>{
    ...
    describe('retrieve test case:', function () {
        it('success retrieve an tradeOrder  ', function () {
            this.timeout(0);
            return request.getRequest(`${directUrl}/tradeOrders/${tradeOrderUUID}`).then( ( { res, body} )=>{
    ...
    describe('update test case:', function () {
        it('success update an tradeOrder', function () {
            ...
            return request.postRequest(`${directUrl}/tradeOrders/${tradeOrderUUID}`,updateInfo).then( ( { res, body} )=>{
    ...
    describe('list test case:', function () {
        it('list tradeOrders by directory:', function () {
            ...
            return request.getRequest(`${directUrl}/tradeOrders`,qs).then( ( { res, body} )=>{
