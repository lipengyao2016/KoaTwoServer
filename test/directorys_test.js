...
describe('Directory Test Case:',()=>{
    ...
    describe('create test case:',  function(){
        it('success create an Directory',  function() {
            this.timeout(0);
            return request.postRequest(`${directUrl}/directorys`,DirectoryTestCase).then( ( { res, body} )=>{
    ...
    describe('retrieve test case:', function () {
        it('success retrieve an Directory  ', function () {
            this.timeout(0);
            return request.getRequest(`${directUrl}/directorys/${DirectoryUUID}`).then( ( { res, body} )=>{
    ...
    describe('update test case:', function () {
        it('success update an Directory', function () {
            ...
            return request.postRequest(`${directUrl}/directorys/${DirectoryUUID}`,updateInfo).then( ( { res, body} )=>{
    ...
    describe('list test case:', function () {
        it('list directorys by directory:', function () {
            ...
            return request.getRequest(`${directUrl}/directorys`,qs).then( ( { res, body} )=>{
