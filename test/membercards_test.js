...
describe('memberCard Test Case:',()=>{
    ...
    describe('create test case:',  function(){
        it('success create an memberCard',  function() {
            this.timeout(0);
            return request.postRequest(`${memberURL}/memberCards`,memberCardTestCase).then( ( { res, body} )=>{
    ...
    describe('retrieve test case:', function () {
        it('success retrieve an memberCard  ', function () {
            this.timeout(0);
            return request.getRequest(`${memberURL}/memberCards/${memberCardUUID}`).then( ( { res, body} )=>{
        ...
        it('success verifyPassword an memberCard  ', function () {
            ...
            return request.postRequest(`${memberURL}/memberCards/${memberCardUUID}/verifyPassword`,{password:'123456'}).then( ( { res, body} )=>{
    ...
    describe('update test case:', function () {
        it('success update an memberCard', function () {
            ...
            return request.postRequest(`${memberURL}/memberCards/${memberCardUUID}`,updateInfo).then( ( { res, body} )=>{
    ...
    describe('list test case:', function () {
        it('list memberCards by memberCard:', function () {
            ...
            return request.getRequest(`${memberURL}/memberCards`,qs).then( ( { res, body} )=>{
        ...
        it('list memberCards by directory:', function () {
            ...
            return request.getRequest(`${directUrl}/memberCards`,qs).then( ( { res, body} )=>{
        ...
        it('list memberCards by api:', function () {
            ...
            return request.getRequest(`${url}/memberCards`,qs).then( ( { res, body} )=>{
