...
describe('memberCardService Test Case:',()=>{
    ...
    describe('create test case:',  function(){
        it('success create an memberCardService',  function() {
            this.timeout(0);
            return request.postRequest(`${memberURL}/memberCardServices`,memberCardServiceTestCase).then( ( { res, body} )=>{
    ...
    describe('retrieve test case:', function () {
        it('success retrieve an memberCardService  ', function () {
            this.timeout(0);
            return request.getRequest(`${memberURL}/memberCardServices/${memberCardServiceUUID}`).then( ( { res, body} )=>{
    ...
    describe('update test case:', function () {
        it('success update an memberCardService', function () {
            ...
            return request.postRequest(`${memberURL}/memberCardServices/${memberCardServiceUUID}`,updateInfo).then( ( { res, body} )=>{
    ...
    describe('list test case:', function () {
        it('list memberCardServices by memberCard:', function () {
            ...
            return request.getRequest(`${memberURL}/memberCardServices`,qs).then( ( { res, body} )=>{
